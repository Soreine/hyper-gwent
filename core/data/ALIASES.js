...
const ALIASES = {
    ...
    Aeromancy: [],
    Aglaïs: [],
    'Alba Armored Cavalry': ['armored cavalry'],
    ...
    'Clan Drummond Warmonger': ['warmonger'],
    ...
    'Clan an Craite Greatsword': ['greatsword'],
    Cleaver: [],
    Cockatrice: [],
    ...
    'Full Moon Potion': ['full moon', 'immunity boost'],
    "Gaunter O'Dimm": ['gaunter odimm', 'gaunter'],
    "Ge'els": ['geels'],
    Geralt: [],
    ...
    'Kaedweni Siege Master': ['kaedweni siege platform', 'ksm', 'siege master'],
    ...
    'Mahakam Guard': [],
    'Mahakam Marauder': [],
    'Mahakam Pyrotechnician': ['pyrotechnician'],
    Malena: [],
    Mangonel: [],
    'Manticore Venom': [],
    'Marching Orders': [],
    ...
    'Poor Flanking Infantry': ['flanking infantry'],
    ...
    'Toad Prince': ['giant toad', 'toad', 'frog'],
